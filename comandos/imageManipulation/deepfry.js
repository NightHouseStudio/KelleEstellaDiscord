...
if (man) {
  ...
  linkP = "https://cdn.discordapp.com/avatars/?";
   ...
   const attachment = `https://summonjs.xyz/api/deepfry?image=${linkC}`

 //const msg = await message.lineReply('Processando...')

 message.lineReply({ files: [{ name: `deepfry.png`, attachment }] }).catch(err => message.lineReply("❌ | ERRO! \n Erro: `" + err + "`"))
 ...
 const attachment = `https://summonjs.xyz/api/deepfry?image=${args[0]}`
