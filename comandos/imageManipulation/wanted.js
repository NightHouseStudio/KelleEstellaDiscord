...
if (man) {
  ...
  linkP = "https://cdn.discordapp.com/avatars/?";
   ...
   const attachment = `https://summonjs.xyz/api/wanted?image=${linkC}`

 //const msg = await message.lineReply('Processando...')

 message.lineReply({ files: [{ name: `wanted.png`, attachment }] }).catch(err => message.lineReply("❌ | ERRO! \n Erro: `" + err + "`"))
 ...
 const attachment = `https://summonjs.xyz/api/wanted?image=${args[0]}`
